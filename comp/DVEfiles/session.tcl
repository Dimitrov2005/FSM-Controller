...
# DVE full session
# Saved on Thu Jul 27 17:23:15 2017
# Designs open: 1
...
#<Session mode="Full" path="/home/SIBIZAPPS/sdimitrov/Projects/lampTest/comp/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{110 147} {1880 1001}}
...
gui_update_layout -id ${HSPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_hier_colhier 1018} {child_hier_coltype 894} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 668} {child_data_colvalue 580} {child_data_coltype 667} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui +v2k}}
gui_set_env SIMSETUP::SIMEXE {/home/SIBIZAPPS/sdimitrov/Projects/lampTest/comp/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/SIBIZAPPS/sdimitrov/Projects/lampTest/comp/simv}] } {
gui_sim_run Ucli -exe simv -args {-ucligui +v2k} -dir /home/SIBIZAPPS/sdimitrov/Projects/lampTest/comp -nosource
}
}
...
set _session_group_3 top
gui_sg_create "$_session_group_3"
set top "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { top.clk top.rst }

set _session_group_4 DUT
gui_sg_create "$_session_group_4"
set DUT "$_session_group_4"

gui_sg_addsignal -group "$_session_group_4" { top.DUT.x1 top.DUT.x2 top.DUT.s1 top.DUT.s2 top.DUT.s3 top.DUT.next top.DUT.state top.DUT.clk top.DUT.cs top.DUT.count top.DUT.rst }
gui_set_radix -radix {decimal} -signals {Sim:top.DUT.s1}
gui_set_radix -radix {unsigned} -signals {Sim:top.DUT.s1}
gui_set_radix -radix {decimal} -signals {Sim:top.DUT.s2}
gui_set_radix -radix {unsigned} -signals {Sim:top.DUT.s2}
gui_set_radix -radix {decimal} -signals {Sim:top.DUT.s3}
gui_set_radix -radix {unsigned} -signals {Sim:top.DUT.s3}
...
gui_open_source -id ${Source.1}  -replace -active uvm_pkg /opt/synopsys/vcs-mx/I-2014.03/etc/uvm-1.1/src/uvm_pkg.sv
