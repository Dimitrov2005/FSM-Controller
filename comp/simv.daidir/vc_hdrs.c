...
void __vcs_export_dpi_dummy_references__()
{
    ...
    void (*fp2)(void) = (void (*)(void)) snps_reg__get_fld_id;
    fp2 = fp2;
    extern void snps_reg__use_context_map(void);
    void (*fp3)(void) = (void (*)(void)) snps_reg__use_context_map;
    fp3 = fp3;
    extern void snps_reg__regRead(void);
    void (*fp4)(void) = (void (*)(void)) snps_reg__regRead;
    fp4 = fp4;
    extern void snps_reg__regWrite(void);
    void (*fp5)(void) = (void (*)(void)) snps_reg__regWrite;
    fp5 = fp5;
}
